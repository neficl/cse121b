...
async function getTemples(){
    const result = await fetch('https://byui-cse.github.io/cse121b-course/week05/temples.json');
...
const sortBy = () => {
    reset();
    let sorter = document.querySelector('#sortBy').value;
    switch(sorter) {
